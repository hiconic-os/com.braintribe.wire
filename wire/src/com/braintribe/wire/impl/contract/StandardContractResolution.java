...
public class StandardContractResolution implements ContractResolution {
	private String className;

	public StandardContractResolution(String className) {
		super();
	...
	public WireSpace resolve(Function<String, WireSpace> spaceFactory) {
		return spaceFactory.apply(className);
	}
}

 ...
 * @deprecated don't use this exception as it has no purpose
 */
@Deprecated
public class WireException extends RuntimeException {
	...
	public WireException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {

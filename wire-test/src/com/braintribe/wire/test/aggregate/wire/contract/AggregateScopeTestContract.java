...
// ============================================================================
package com.braintribe.wire.test.aggregate.wire.contract;
...
public interface AggregateScopeTestContract extends WireSpace {
	TestNode root(TestContext context);
	TestNode sub1();

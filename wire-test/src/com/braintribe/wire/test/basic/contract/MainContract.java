...
// ============================================================================
package com.braintribe.wire.test.basic.contract;
...
public interface MainContract extends WireSpace {
	...
	Resource resource();
	ExampleBean bean1();
	ExampleBean a1Holder();
	ExampleBean a1();
	BeanOriginManager beanOriginManager();
	ExampleBean anotherExample();
	String qualification();
	String paramTest(Double param);

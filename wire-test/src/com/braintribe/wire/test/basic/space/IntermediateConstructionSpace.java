...
@Managed
public class IntermediateConstructionSpace implements IntermediateConstructionContract {

	@Managed
	@Override
	public ExampleBean button() {
		
		ExampleBean bean = new ExampleBean();
		configureButton(bean);

		return bean;
	}

	protected void configureButton(ExampleBean bean) {
